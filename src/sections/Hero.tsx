  ...
  return (
   ...
   <HeroOrbit size={430} rotation={-15}>
        ...
        <StarIcon className="size-5 text-emerald-300/20" />
              ...
              <HeroOrbit size={730} rotation={178}>
      ...
      <div className="container">
        <div className="flex flex-col items-center">
          ...
          />
          <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center rounded-lg gap-4 mt-4">
