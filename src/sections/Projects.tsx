  ...
  return <section className="pb-16 lg:py-24">
    <div className="container">
     <div className="flex justify-center">
       <p className="uppercase font-semibold tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text text-transparent">Real-world Results</p>
      
     </div>

      <h2 className="font-serif text-3xl md:text-5xl text-center mt-6">Featured Project</h2>
      ...
      <div className="mt-10 md:mt-20 flex flex-col  gap-[3.75rem]">
        {portfolioProjects.map(project=>(
          <div key={project.title} className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden 
          after:-z-10 after:content-[''] after:absolute after:inset-0 after:outlinr-2 after:outline
           after:outline-offset-2  after:outline-white/20 px-8 pt-8 md:pt-12 lg:pt-16 lg:px-20 after:pointer-events-none">
          <div className="absolute insert-0 -z-10 opacity-5" style={{background:`url(${grainImage.src})`}}></div>
         ...
         <a href={project.link}>
             ...
             inline-flex items-center justify-center gap-2 mt-8">
              <span>Visit Live Site</span><ArrowUpRightIcon className="size-4"/></button>
         </a>
         </div>
