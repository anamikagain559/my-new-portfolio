  ...
  return <div>
    <div className="container">
     <div className="flex justify-center">
      ...
      <h2 className="font-serif text-3xl text-center mt-6">Featured Project</h2>
      ...
      <div className="flex flex-col mt-10">
        {portfolioProjects.map(project=>(
          ...
          after:-z-10 after:content-[''] after:absolute after:inset-0 after:outlinr-2 after:outline after:outline-offset-2  after:outline-white/20 p-8">
            <div className="flex">
         ...
         <a href={project.link}>
             <button className="bg-white text-gray-950 h-12 w-full rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8"><span>View Live Site</span><ArrowUpRightIcon className="size-4"/></button>
         </a>
